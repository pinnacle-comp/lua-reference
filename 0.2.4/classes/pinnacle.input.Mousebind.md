...
# Class `pinnacle.input.Mousebind` : <code><a href="/lua-reference/0.2.4/classes/pinnacle.input.Bind">pinnacle.input.Bind</a></code>
...
`button`: <code><a href="/lua-reference/0.2.4/enums/pinnacle.input.MouseButton">pinnacle.input.MouseButton</a></code>
