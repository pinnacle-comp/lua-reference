...
<div class="language-lua"><pre><code>function pinnacle.process.spawn(...: string)
    -> <a href="/lua-reference/0.2.4/classes/pinnacle.process.Child">pinnacle.process.Child</a>?</code></pre></div>
...
1. <code><a href="/lua-reference/0.2.4/classes/pinnacle.process.Child">pinnacle.process.Child</a></code> - A child with the process's standard IO, or `nil` if the process failed to spawn or doesn't exist.



#### See also

- <code><a href="/lua-reference/0.2.4/classes/pinnacle.process#Process.command">pinnacle.process.Process.command</a></code>: A way to spawn processes with more control.
...
<div class="language-lua"><pre><code>function pinnacle.process.command(cmd: <a href="/lua-reference/0.2.4/classes/pinnacle.process.CommandOpts">pinnacle.process.CommandOpts</a>)
    -> <a href="/lua-reference/0.2.4/classes/pinnacle.process.Command">pinnacle.process.Command</a></code></pre></div>
...
&emsp; ┃ <code><a href="/lua-reference/0.2.4/classes/pinnacle.process.CommandOpts">pinnacle.process.CommandOpts</a></code><br>



#### Returns

1. <code><a href="/lua-reference/0.2.4/classes/pinnacle.process.Command">pinnacle.process.Command</a></code> - An object that allows you to spawn this command.
