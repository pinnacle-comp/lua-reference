...
# Class `pinnacle.layout.builtin.Line` : <code><a href="/lua-reference/0.2.0-alpha.2/classes/pinnacle.layout.LayoutGenerator">pinnacle.layout.LayoutGenerator</a></code>
...
`direction`: <code><a href="/lua-reference/0.2.0-alpha.2/aliases/pinnacle.layout.LayoutDir">pinnacle.layout.LayoutDir</a></code>
