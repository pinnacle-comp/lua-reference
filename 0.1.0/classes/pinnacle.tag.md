...
<div class="language-lua"><pre><code>function pinnacle.tag.get(name: string, output?: <a href="/lua-reference/0.1.0/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a>)
    -> <a href="/lua-reference/0.1.0/classes/pinnacle.tag.TagHandle">pinnacle.tag.TagHandle</a> | nil</code></pre></div>
...
`output?`: <code><a href="/lua-reference/0.1.0/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a></code> - The output to get the tag on, or `nil` for the focused output.



#### Returns

1. <code><a href="/lua-reference/0.1.0/classes/pinnacle.tag.TagHandle">pinnacle.tag.TagHandle</a> | nil</code>
...
<div class="language-lua"><pre><code>function pinnacle.tag.add(output: <a href="/lua-reference/0.1.0/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a>, ...: string)
    -> tags: <a href="/lua-reference/0.1.0/classes/pinnacle.tag.TagHandle">pinnacle.tag.TagHandle</a>[]</code></pre></div>
...
`output`: <code><a href="/lua-reference/0.1.0/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a></code> - The output to add tags to.<br>
...
1. `tags`: <code><a href="/lua-reference/0.1.0/classes/pinnacle.tag.TagHandle">pinnacle.tag.TagHandle</a>[]</code> - Handles to the created tags.
...
<div class="language-lua"><pre><code>function pinnacle.tag.remove(tags: <a href="/lua-reference/0.1.0/classes/pinnacle.tag.TagHandle">pinnacle.tag.TagHandle</a>[])</code></pre></div>
...
`tags`: <code><a href="/lua-reference/0.1.0/classes/pinnacle.tag.TagHandle">pinnacle.tag.TagHandle</a>[]</code> - The tags to remove.
...
<div class="language-lua"><pre><code>function pinnacle.tag.connect_signal(signals: <a href="/lua-reference/0.1.0/classes/pinnacle.tag.TagSignal">pinnacle.tag.TagSignal</a>)
...
`signals`: <code><a href="/lua-reference/0.1.0/classes/pinnacle.tag.TagSignal">pinnacle.tag.TagSignal</a></code> - The signal you want to connect to
