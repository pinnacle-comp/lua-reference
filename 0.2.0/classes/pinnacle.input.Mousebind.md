...
# Class `pinnacle.input.Mousebind` : <code><a href="/lua-reference/0.2.0/classes/pinnacle.input.Bind">pinnacle.input.Bind</a></code>
...
`button`: <code><a href="/lua-reference/0.2.0/enums/pinnacle.input.MouseButton">pinnacle.input.MouseButton</a></code>
