...
<div class="language-lua"><pre><code>function pinnacle.output.get_by_name(name: string)
    -> <a href="/lua-reference/0.2.0/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a> | nil</code></pre></div>
...
1. <code><a href="/lua-reference/0.2.0/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a> | nil</code>
...
<div class="language-lua"><pre><code>function pinnacle.output.for_each_output(for_each: fun(output: <a href="/lua-reference/0.2.0/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a>))</code></pre></div>
...
&emsp; ┃ <code>fun(output: <a href="/lua-reference/0.2.0/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a>)</code><br>
...
<div class="language-lua"><pre><code>function pinnacle.output.connect_signal(signals: <a href="/lua-reference/0.2.0/classes/pinnacle.output.OutputSignal">pinnacle.output.OutputSignal</a>)
...
&emsp; ┃ <code><a href="/lua-reference/0.2.0/classes/pinnacle.output.OutputSignal">pinnacle.output.OutputSignal</a></code><br>
