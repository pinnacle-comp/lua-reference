...
# Class `pinnacle.input.Keybind` : <code><a href="/lua-reference/0.2.3/classes/pinnacle.input.Bind">pinnacle.input.Bind</a></code>
...
`key`: <code>string | <a href="/lua-reference/0.2.3/enums/pinnacle.input.Key">pinnacle.input.Key</a></code>
