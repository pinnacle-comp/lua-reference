...
- <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.output.OutputHandle#set_loc_adj_to">pinnacle.output.OutputHandle.set_loc_adj_to</a></code>: A helper function to move outputs relative to other outputs.
### <Badge type="method" text="method" /> set_loc_adj_to

<div class="language-lua"><pre><code>function pinnacle.output.OutputHandle:set_loc_adj_to(other: <a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a>, alignment: <a href="/lua-reference/0.1.0-beta.1/aliases/pinnacle.output.Alignment">pinnacle.output.Alignment</a>)</code></pre></div>
...
`other`: <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a></code> - The output to move this output relative to.<br>
`alignment`: <code><a href="/lua-reference/0.1.0-beta.1/aliases/pinnacle.output.Alignment">pinnacle.output.Alignment</a></code> - How to align this output with the other output.
...
<div class="language-lua"><pre><code>function pinnacle.output.OutputHandle:set_modeline(modeline: string | <a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.output.Modeline">pinnacle.output.Modeline</a>)</code></pre></div>
...
`modeline`: <code>string | <a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.output.Modeline">pinnacle.output.Modeline</a></code> - A modeline table, or a modeline string to feed it into `parse_modeline`.
...
- <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.util.output#parse_modeline">pinnacle.util.output.parse_modeline</a></code>
...
<div class="language-lua"><pre><code>function pinnacle.output.OutputHandle:set_transform(transform: <a href="/lua-reference/0.1.0-beta.1/enums/pinnacle.output.Transform">pinnacle.output.Transform</a>)</code></pre></div>
...
`transform`: <code><a href="/lua-reference/0.1.0-beta.1/enums/pinnacle.output.Transform">pinnacle.output.Transform</a></code> - The new transform.
...
<div class="language-lua"><pre><code>function pinnacle.output.OutputHandle:current_mode()
    -> <a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.output.Mode">pinnacle.output.Mode</a>?</code></pre></div>
...
1. <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.output.Mode">pinnacle.output.Mode</a></code> - The current mode, or `nil` if the output is disabled or doesn't exist.
...
1. <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.output.Mode">pinnacle.output.Mode</a></code> - The preferred mode, or `nil` if the output doesn't exist.
...
1. <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.output.Mode">pinnacle.output.Mode</a>[]</code>
...
<div class="language-lua"><pre><code>function pinnacle.output.OutputHandle:transform()
    -> <a href="/lua-reference/0.1.0-beta.1/enums/pinnacle.output.Transform">pinnacle.output.Transform</a></code></pre></div>
...
1. <code><a href="/lua-reference/0.1.0-beta.1/enums/pinnacle.output.Transform">pinnacle.output.Transform</a></code>
...
<div class="language-lua"><pre><code>function pinnacle.output.OutputHandle:keyboard_focus_stack()
    -> <a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.window.WindowHandle">pinnacle.window.WindowHandle</a>[]</code></pre></div>
...
1. <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.window.WindowHandle">pinnacle.window.WindowHandle</a>[]</code>



#### See also

- <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.output.OutputHandle#keyboard_focus_stack_visible">pinnacle.output.OutputHandle.keyboard_focus_stack_visible</a></code>
...
- <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.output.OutputHandle#keyboard_focus_stack">pinnacle.output.OutputHandle.keyboard_focus_stack</a></code>