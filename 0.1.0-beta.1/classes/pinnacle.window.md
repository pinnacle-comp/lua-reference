...
<div class="language-lua"><pre><code>function pinnacle.window.get_all()
    -> windows: <a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.window.WindowHandle">pinnacle.window.WindowHandle</a>[]</code></pre></div>
...
1. `windows`: <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.window.WindowHandle">pinnacle.window.WindowHandle</a>[]</code> - Handles to all windows
...
<div class="language-lua"><pre><code>function pinnacle.window.get_focused()
    -> window: <a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.window.WindowHandle">pinnacle.window.WindowHandle</a> | nil</code></pre></div>
...
1. `window`: <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.window.WindowHandle">pinnacle.window.WindowHandle</a> | nil</code> - A handle to the currently focused window
...
<div class="language-lua"><pre><code>function pinnacle.window.begin_move(button: <a href="/lua-reference/0.1.0-beta.1/enums/pinnacle.input.MouseButton">pinnacle.input.MouseButton</a>)</code></pre></div>
...
`button`: <code><a href="/lua-reference/0.1.0-beta.1/enums/pinnacle.input.MouseButton">pinnacle.input.MouseButton</a></code> - The button that will initiate the move
...
<div class="language-lua"><pre><code>function pinnacle.window.begin_resize(button: <a href="/lua-reference/0.1.0-beta.1/enums/pinnacle.input.MouseButton">pinnacle.input.MouseButton</a>)</code></pre></div>
...
`button`: <code><a href="/lua-reference/0.1.0-beta.1/enums/pinnacle.input.MouseButton">pinnacle.input.MouseButton</a></code> - The button that will initiate the resize
...
<div class="language-lua"><pre><code>function pinnacle.window.connect_signal(signals: <a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.window.WindowSignal">pinnacle.window.WindowSignal</a>)
...
`signals`: <code><a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.window.WindowSignal">pinnacle.window.WindowSignal</a></code> - The signal you want to connect to
...
<div class="language-lua"><pre><code>function pinnacle.window.add_window_rule(rule: fun(window: <a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.window.WindowHandle">pinnacle.window.WindowHandle</a>))</code></pre></div>
...
`rule`: <code>fun(window: <a href="/lua-reference/0.1.0-beta.1/classes/pinnacle.window.WindowHandle">pinnacle.window.WindowHandle</a>)</code> - A function that will run with all new, unmapped windows.
