...
`mods`: <code><a href="/lua-reference/0.2.2/enums/pinnacle.input.Mod">pinnacle.input.Mod</a>[]</code>

The bind's modifiers.

### ignore_mods

`ignore_mods`: <code><a href="/lua-reference/0.2.2/enums/pinnacle.input.Mod">pinnacle.input.Mod</a>[]</code>
...
`kind`: <code><a href="/lua-reference/0.2.2/classes/pinnacle.input.BindInfoKind">pinnacle.input.BindInfoKind</a></code>
