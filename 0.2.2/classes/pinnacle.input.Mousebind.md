...
# Class `pinnacle.input.Mousebind` : <code><a href="/lua-reference/0.2.2/classes/pinnacle.input.Bind">pinnacle.input.Bind</a></code>
...
`button`: <code><a href="/lua-reference/0.2.2/enums/pinnacle.input.MouseButton">pinnacle.input.MouseButton</a></code>
