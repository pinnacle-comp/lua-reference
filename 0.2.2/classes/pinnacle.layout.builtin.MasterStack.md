...
# Class `pinnacle.layout.builtin.MasterStack` : <code><a href="/lua-reference/0.2.2/classes/pinnacle.layout.LayoutGenerator">pinnacle.layout.LayoutGenerator</a></code>
...
`outer_gaps`: <code><a href="/lua-reference/0.2.2/aliases/pinnacle.layout.Gaps">pinnacle.layout.Gaps</a></code>

The gaps between the outer container and this layout.

### inner_gaps

`inner_gaps`: <code><a href="/lua-reference/0.2.2/aliases/pinnacle.layout.Gaps">pinnacle.layout.Gaps</a></code>
