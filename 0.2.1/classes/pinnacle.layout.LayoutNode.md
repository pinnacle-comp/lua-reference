...
`layout_dir?`: <code><a href="/lua-reference/0.2.1/aliases/pinnacle.layout.LayoutDir">pinnacle.layout.LayoutDir</a></code>

The direction that child nodes are laid out.

### gaps <Badge type="danger" text="nullable" />

`gaps?`: <code>number | <a href="/lua-reference/0.2.1/aliases/pinnacle.layout.Gaps">pinnacle.layout.Gaps</a></code>
...
`children?`: <code><a href="/lua-reference/0.2.1/classes/pinnacle.layout.LayoutNode">pinnacle.layout.LayoutNode</a>[]</code>
