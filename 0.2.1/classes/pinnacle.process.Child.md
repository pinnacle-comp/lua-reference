...
`stdin?`: <code><a href="/lua-reference/0.2.1/classes/pinnacle.process.ChildStdin">pinnacle.process.ChildStdin</a></code>
...
`stdout?`: <code><a href="/lua-reference/0.2.1/classes/pinnacle.process.ChildStdout">pinnacle.process.ChildStdout</a></code>
...
`stderr?`: <code><a href="/lua-reference/0.2.1/classes/pinnacle.process.ChildStderr">pinnacle.process.ChildStderr</a></code>
