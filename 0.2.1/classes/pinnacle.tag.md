...
<div class="language-lua"><pre><code>function pinnacle.tag.get(name: string, output: <a href="/lua-reference/0.2.1/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a>)
    -> <a href="/lua-reference/0.2.1/classes/pinnacle.tag.TagHandle">pinnacle.tag.TagHandle</a> | nil</code></pre></div>
...
1. <code><a href="/lua-reference/0.2.1/classes/pinnacle.tag.TagHandle">pinnacle.tag.TagHandle</a> | nil</code>
...
<div class="language-lua"><pre><code>function pinnacle.tag.add(output: <a href="/lua-reference/0.2.1/classes/pinnacle.output.OutputHandle">pinnacle.output.OutputHandle</a>, ...: string)
    -> tags: <a href="/lua-reference/0.2.1/classes/pinnacle.tag.TagHandle">pinnacle.tag.TagHandle</a>[]</code></pre></div>
...
1. `tags`: <code><a href="/lua-reference/0.2.1/classes/pinnacle.tag.TagHandle">pinnacle.tag.TagHandle</a>[]</code> - Handles to the created tags.
...
<div class="language-lua"><pre><code>function pinnacle.tag.remove(tags: <a href="/lua-reference/0.2.1/classes/pinnacle.tag.TagHandle">pinnacle.tag.TagHandle</a>[])</code></pre></div>
...
<div class="language-lua"><pre><code>function pinnacle.tag.connect_signal(signals: <a href="/lua-reference/0.2.1/classes/pinnacle.tag.TagSignal">pinnacle.tag.TagSignal</a>)
...
&emsp; ┃ <code><a href="/lua-reference/0.2.1/classes/pinnacle.tag.TagSignal">pinnacle.tag.TagSignal</a></code><br>
